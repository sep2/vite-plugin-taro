...
export const LIST_TYPE = [['reservedFunds', 'busniessLoan', 'group'], ['busniessLoan'], ['reservedFunds']]

export const COMPUTE_WAY = [['loan'], ['house', 'loan']]
            ...
            : [
                  {
                      ...
                      type: 'selector',
                      rangeFilter: commerceLoanYear > 5 ? 'outFive' : commerceLoanYear > 1 ? 'inFive' : 'inOne',
...
export const MONTY_TITLE: Record<string, string> = {
