...
import { Input, Text, View } from 'vite-plugin-taro/components'
    ...
    render() {
        ...
        return (
            <View className="relative flex flex-col flex-1 bg-white h-screen w-full overflow-hidden">
                ...
                >
                    <View
                        className="flex p-2 m-4 flex-1 items-center justify-center rounded-xs bg-[rgba(35,201,147,1)] text-center"
                        onClick={this.submit}
                    >
