...
The package build consumes pinned development dependencies for Taro's runtime, generic APIs, Taro facade, components, router, H5 APIs, React renderer, React framework runtime, and WeChat, Alipay, TikTok/ByteDance, and Web platform packages. It emits only the application runtime files used by VPT, so Taro's compiler packages do not become production dependencies of generated projects.
