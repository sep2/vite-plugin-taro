 ...
 *   SystemJS runtime. Native shells enter that graph through bootstrap's exported `System.importSync`, and asynchronous
 *   boundaries use the same runtime through `System.import`.
 *
