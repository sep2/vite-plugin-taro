---
title: 开发者工具热更新
description: 在微信开发者工具中更新 React 组件并保留应用、页面和组件状态。
---
...
需要了解物理文件边界、模块传播、React Refresh 适配和 Taro 页面重新绑定时，请阅读 [HMR 实现原理](/vite-plugin-taro/references/hmr-implementation/)。
